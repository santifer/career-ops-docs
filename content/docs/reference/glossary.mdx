...
The AI coding CLI that executes career-ops prompts — Claude Code, Gemini CLI, Codex, Qwen Code, OpenCode, or GitHub Copilot CLI — or any OpenAI-compatible endpoint. career-ops is engine-agnostic and [runs on free engines too](/docs/free-ai-engine).
